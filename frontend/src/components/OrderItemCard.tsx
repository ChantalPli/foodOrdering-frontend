...
export default function OrderItemCard({ order }: Props) {
  ...
  const [status, setStatus] = useState<OrderStatus>(order.status)//to set the value of the selected dropdown
    ...
    <Card>
      ...
      <CardContent className="flex flex-col gap-6">
        ...
        <div className="flex flex-col space-y-1.5">
          <Label htmlFor="status">What is the status of this orders?</Label>
          <Select
            value={status}
            disabled={isLoading}
